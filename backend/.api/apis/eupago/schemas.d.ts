declare const ApplePay: {
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly customer: {
                readonly type: "object";
                readonly description: "Informations regarding the customer";
                readonly properties: {
                    readonly notify: {
                        readonly type: "boolean";
                        readonly description: "If ‘true’, and if the customer’s email is provided in the request, they will be notified via email about the generation of the reference";
                    };
                    readonly email: {
                        readonly type: "string";
                        readonly description: "Customer's email for reference generation notification";
                    };
                    readonly firstName: {
                        readonly type: "string";
                        readonly description: "Customer's first name. (when not sent, it will be request on the payment form)";
                    };
                    readonly lastName: {
                        readonly type: "string";
                        readonly description: "Customer's last name. (when not sent, it will be request on the payment form)";
                    };
                    readonly countryCode: {
                        readonly type: "string";
                        readonly description: "Customer's country code on ISO 3166-1 alpha-2 code format. EG: \"PT\" (when not sent, it will be request on the payment form)";
                    };
                };
            };
        };
        ...
        readonly "200": {
            ...
            readonly properties: {
                ...
                readonly redirectUrl: {
                    readonly type: "string";
                    readonly examples: readonly ["https://sandbox.eupago.pt/api/extern/euapplepay/form/fc4740349d5b350eca08fa5e503fa0aa"];
                };
            };
            readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
        };
...
declare const DirectDebitAuthorization: {
    readonly body: {
        readonly type: "object";
        readonly required: readonly ["identifier", "debtor", "payment"];
        readonly properties: {
            readonly identifier: {
                readonly type: "string";
        ...
        readonly properties: {
            readonly payment: {
                ...
                readonly properties: {
                    ...
                    readonly backUrl: {
                        readonly type: "string";
                        readonly description: "The customer will be forwarded to this url if the user presses back.";
                    };
                    readonly successUrl: {
                        readonly type: "string";
                        readonly description: "The customer will be forwarded to this url if the payment process is successful.The payer will be forwarded to this url if the user presses back.";
                    };
                    readonly failUrl: {
                        readonly type: "string";
                        readonly description: "The customer will be forwarded to this url if the payment process fails (eg: no funds)";
                    };
            ...
            readonly installmentCode: {
                ...
                readonly enum: readonly ["BC3XFPT"];
            };
            readonly items: {
                readonly type: "object";
                readonly description: "All items in the order. This param may include different objects (items).";
            ...
            readonly shippingAddress: {
                readonly type: "object";
                readonly description: "Address where the products will be shipped to the customer";
                readonly properties: {
        ...
        readonly properties: {
            ...
            readonly customer: {
                ...
                readonly properties: {
                    ...
                    readonly email: {
                        readonly type: "string";
                        readonly description: "Customer's email (when not sent, it will be request on the payment form)";
                    };
                    readonly firstName: {
                        readonly type: "string";
                        readonly description: "Customer's first name. (when not sent, it will be request on the payment form)";
    ...
    readonly response: {
        readonly "201": {
            ...
            readonly properties: {
                ...
                readonly redirectUrl: {
                    readonly type: "string";
                    readonly examples: readonly ["https://sandbox.eupago.pt/api/extern/googlepay/form/fc4740349d5b350eca08fa5e503fa0aa"];
                };
            };
            readonly $schema: "https://json-schema.org/draft/2020-12/schema#";
        };
...
export { ApplePay, Bizum, CofidisPay, CreditCard, CreditCardRecurrenceAuthorization, CreditCardRecurrencePayment, DirectDebitAuthorization, DirectDebitPayment, Europix, FloaCreate, FloaPaySimulation, GooglePay, Mbway, P24, Pagaqui, Paybylink, PaybylinkQrcode, SantanderConsumer, SplitPayments };
