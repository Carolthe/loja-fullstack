    ...
    <section className="w-full px-[5vw]">
      <div className=" bg-[#f6f7f7] flex justify-between items-center rounded-[15px] w-full h-[150px] px-5">
        <div className="max-w-[70%]">
          <p className="font-semibold text-azulEscuro text-[20px]">Categoria Quarto</p>
          <p className="text-fontGray text-[15px] leading-tight">Os melhores produtos para o seu quarto</p>
        </div>
        <img src={quarto}
