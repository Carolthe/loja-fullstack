        ...
        <footer className="bg-[#5769a9] text-white">
            <div className="max-w-6xl mx-auto px-6 py-[28px] grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
                <div className="flex flex-col items-center md:items-start gap-3">
                    ...
                    <p className="flex items-center gap-2 text-sm"><FaWhatsapp />+351 937 628 516</p>
                    <p className="flex items-center gap-2 text-sm"><AiOutlineMail />homehaven1998@gmail.com</p>
                </div>

                <div className="flex flex-col gap-4">
                    <div>
                        <h3 className="font-semibold text-sm uppercase tracking-wide mb-2">Nossa Política</h3>
                    ...
                    <div>
                        <h3 className="font-semibold text-sm uppercase tracking-wide mb-2">Redes Sociais</h3>
            ...
            <div className="py-4 text-center text-sm opacity-80">© 2025 Homehaven. Todos os direitos reservados.</div>
        </footer>
    )
}
