    ...
    return (
        <>
            <div className="mt-[15 px] mx-[15px]" >
                ...
                <p className="flex items-center pl-[10px] bg-[#f6e365] rounded-[15px] h-[50px] mb-[5px]" ><span className="font-semibold pr-[5px]">Envio:</span> Gratuito</p>
                <p className="flex items-center pl-[10px] bg-[#f6e365] rounded-[15px] h-[50px] mb-[5px] ">Pagamento seguro </p>
                <p className="flex items-center pl-[10px] bg-[#f6e365] rounded-[15px] h-[50px] "><span className="font-semibold">Estimativa de entrega:</span> 10-30 dias úteis</p>
