...
export default function Login() {
    ...
    return (
        <div className="h-[100vh]">
            <div>
                <div className="relative bg-[#5769a9] h-[190px] flex flex-col items-center justify-center text-center md:h-[250px]">
                ...
                <form className="flex flex-col items-center pb-6 "
                    ...
                    <div className="mt-[35px] md:mt-[-5px]">
                    ...
                    <button className="w-75 h-[55px] mt-[25px] bg-amarelo-principal font-bold text-white text-[21px] rounded-[15px] md:w-[500px]">Login</button>
                    <Link to="/password-recovery">
                        <p className="mt-3.75 text-azul-principal md:mb-[-60px]">Recuperar a Senha</p>
                    </Link>
